...
public class DeltaAlgebra<Ty, Sym, En1, Fk1, Att1, Gen, Sk, En2, Fk2, Att2, X, Y> 
extends Algebra<Ty, Sym, En1, Fk1, Att1, Pair<En1, X>, Y, Pair<En1, X>, Y> {
 
	
	private final Mapping<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2> F;
	private final Algebra<Ty, Sym, En2, Fk2, Att2, Gen, Sk, X, Y> alg;
	...
	public DeltaAlgebra(Mapping<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2> F, Algebra<Ty, Sym, En2, Fk2, Att2, Gen, Sk, X, Y> alg) {
		this.F = F;
		this.alg = alg;
	}
	...
	public Term<Ty, Sym, En2, Fk2, Att2, Gen, Sk> translate(Term<Ty, Sym, En1, Fk1, Att1, Pair<En1, X>, Y> e) {
		if (e.var != null) {
			...
			Term<Ty, Sym, En2, Fk2, Att2, Gen, Sk> t = F.atts.get(e.att).third.map(Function.identity(), Function.identity(), Function.identity(), Function.identity(), Util.voidFn(), Util.voidFn());
	...
	/*
	 private Term<Void,En2,Void,Fk2,Void,Gen,Void> translateE(Term<Void, Void, En1, Fk1, Void, Pair<En1, X>, Void> e) {
...
/*
	private En1 type(Term<Ty, Sym, En1, Fk1, Att1, Pair<En1, X>, Sk> e) {
		if (e.gen != null) {
			return e.gen.first;
		} else if (e.fk != null) {
	...
	@Override
	public Term<Void, Void, En1, Fk1, Void, Pair<En1, X>, Void> repr(Pair<En1, X> x) {
		return Term.Gen(x);
	}

	@Override
	public Term<Ty, Sym, Void, Void, Void, Void, Y> att(Att1 att, Pair<En1, X> e) {
		Term<Ty, Sym, Void, Void, Void, Void, Y> ret =  attY(F.atts.get(att).third, e);
		return alg.intoY(alg.reprT(ret));
	}

	private Term<Ty, Sym, Void, Void, Void, Void, Y> attY(Term<Ty, Sym, En2, Fk2, Att2, Void, Void> term, Pair<En1, X> x) {
		if (term.obj != null) {
	...
	@Override
	public Term<Ty, Sym, En1, Fk1, Att1, Pair<En1, X>, Y> reprT_protected(Term<Ty, Sym, Void, Void, Void, Void, Y> term) {
		Term<Ty, Sym, Void, Void, Void, Void, Y> t = alg.intoY(alg.reprT(term));
