...
public class SigmaInstance<Ty, Sym, En1, Fk1, Att1, Gen, Sk, En2, Fk2, Att2, X, Y> 
 extends Instance<Ty, Sym, En2, Fk2, Att2, Gen, Sk, ID, Chc<Sk, Pair<ID, Att2>>> {
	
	private final Mapping<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2> F;
	private final Instance<Ty, Sym, En1, Fk1, Att1, Gen, Sk, X, Y> I;
	private final LiteralInstance<Ty, Sym, En2, Fk2, Att2, Gen, Sk, ID, Chc<Sk, Pair<ID, Att2>>> J;

	//options has to come in as a list, because conversion to AqlOptions requires the sigma'd collage
	public SigmaInstance(Mapping<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2> f, Instance<Ty, Sym, En1, Fk1, Att1, Gen, Sk, X, Y> i, AqlOptions strat) {
		...
		*/
		...
		InitialAlgebra<Ty, Sym, En2, Fk2, Att2, Gen, Sk, ID> initial 
	...
	@Override
	public Set<Pair<Term<Ty, Sym, En2, Fk2, Att2, Gen, Sk>, Term<Ty, Sym, En2, Fk2, Att2, Gen, Sk>>> eqs() {
		return J.eqs();
	}
	
	@Override
	public DP<Ty, Sym, En2, Fk2, Att2, Gen, Sk> dp() {
		return J.dp();
	}
	
	@Override
	public Algebra<Ty, Sym, En2, Fk2, Att2, Gen, Sk, ID, Chc<Sk, Pair<ID, Att2>>> algebra() {
		return J.algebra();
	}
