...
public class SigmaChaseAlgebra<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2, Gen, Sk, X, Y>
		extends Algebra<Ty, Sym, En2, Fk2, Att2, Gen, Sk, Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>>
	...
	private Chase<Ty, Sym, En1,Fk1,Att1,En2,Fk2,Att2,Gen,Sk,X,Y> chase;
	
	public SigmaChaseAlgebra(Mapping<Ty, Sym, En1, Fk1, Att1, En2, Fk2, Att2> f2,
		...
		chase = new Chase<Ty, Sym, En1,Fk1,Att1,En2,Fk2,Att2,Gen,Sk,X,Y>(F, X);
		
		for (En2 en2 : B.ens) {
			Collection<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>> s = chase.T.ens.get(en2).keySet();
			ens0.put(en2, s);
		}
	...
	private final Ctx<En2, Collection<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>>> ens0 = new Ctx<>();
	...
	@Override
	public Lineage<Void, Void, En2, Fk2, Void, Gen, Void> gen(Gen gen) {
	...
	private Term<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>> reprT0(Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>> y) {
		return schema().typeSide.js.java_tys.isEmpty() ? simpl(Term.Sk(y))
				: schema().typeSide.js.reduce(simpl(Term.Sk(y)));
	} 
	
	@Override
	public synchronized Lineage<Void, Void, En2, Fk2, Void, Gen, Void> fk(Fk2 fk2, Lineage<Void, Void, En2, Fk2, Void, Gen, Void> x) {
	...
	private final List<Pair<Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>, 
	Term<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>>>> 
	list = new LinkedList<>();
	
	
	@Override
	public synchronized Collage<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>> talg() {
	...
	private Term<Ty, Sym, En2, Fk2, Att2, Gen, Sk> unflatten(Term<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>> term) {
		if (term.obj != null) {
	...
	private Term<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>> simpl(Term<Ty, Sym, Void, Void, Void, Void, Chc<Sk, Pair<Lineage<Void, Void, En2, Fk2, Void, Gen, Void>, Att2>>> y) {
	...
	@Override
	public Term<Void, Void, En2, Fk2, Void, Gen, Void> repr(
