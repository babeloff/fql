...
public class InitialInstanceEx<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> extends Instance<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> {

	private final Schema<Ty, En, Sym, Fk, Att> schema;
	
	public InitialInstanceEx(Schema<Ty, En, Sym, Fk, Att> schema) {
		this.schema = schema;
		validate();
	}
	...
	public DP<Ty, En, Sym, Fk, Att, Gen, Sk> dp() {
		return (DP<Ty, En, Sym, Fk, Att, Gen, Sk>) schema.dp;
	}

	@SuppressWarnings("unchecked")
	@Override
	public Algebra<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y> algebra() {
		return (Algebra<Ty, En, Sym, Fk, Att, Gen, Sk, X, Y>) new EmptyAlgebra();
	}
	
	@SuppressWarnings("ConstantConditions")
	public class EmptyAlgebra extends Algebra<Ty, En, Sym, Fk, Att, Void, Void, Void, Void>  {
